...
class Login{
  ...
  * @param string $wachtwoord: The value of the Wachtwoord input field
  */
  public function voegLoginUit($email, $wachtwoord){
    ...
    * @param string $email: The value of the Email input field
    * @param string $wachtwoord: The value of the Wachtwoord input field
    * @return bool: True, if there are actually strings send
    */
    ...
    * @param string $email: The email adres which is matched to the email column in the Persoon table
    * @return int $klantId: The id form the account where the email column matches the parameter
    */
    ...
    * @param int $id: The user's id that will be matched with the persoon column
    * @return string $ww: The user's hashed password
    */
    ...
    * @param string $wachtwoord: The information that is submitted in the Wachtwoord field
    * @param string $opgehaaldWachtwoord: The hash of the password that is fetched from the database
    * @param int $id: The id of the user that is trying to log in
    */
